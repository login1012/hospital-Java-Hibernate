...
public class HospitalTest {
    private static final Logger log = LogManager.getLogger(HospitalTest.class);
    ...
    public void getSet(){
        ...
        assertNotEquals(hospital.getId(), null);
    }
    ...
    public void getList(){
        ...
        log.debug("GET LIST" + hospital.toString());
        log.debug("GET LIST" + hospital.getList().toString());
        assertNotEquals(provider.getHospital(1), Optional.empty());
    }
