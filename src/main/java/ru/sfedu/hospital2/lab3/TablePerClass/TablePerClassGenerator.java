...
import ru.sfedu.hospital2.lab3.TablePerClass.*;
import ru.sfedu.hospital2.lab3.TablePerClass.*;
import ru.sfedu.hospital2.lab3.TablePerClass.*;
...
import ru.sfedu.hospital2.lab3.TablePerClass.HibernateDataProvider;
...
public class TablePerClassGenerator {
    private static final Logger log = LogManager.getLogger(TablePerClassGenerator.class);
    ...
    public  List<Employee> generateEmployee() {
     ...
     public  List<Appointment> generateAppointment() {
        ...
        for (int i = 0; i < 2; i++) {
            Appointment appointment = new Appointment();
                ...
                NativeQuery employeeQuery = employeeSession.createNativeQuery(Constants.TABLEPERCLASS_EMPLOYEE);
                ...
                NativeQuery patientQuery = patientSession.createNativeQuery(Constants.TABLEPERCLASS_PATIENT);
     ...
     public  List<Diagnosis> generateDiagnosis() {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            diagnosis.setSignature(false);            
                ...
                NativeQuery serviceQuery = serviceSession.createNativeQuery(Constants.TABLEPERCLASS_SURVEY);
     ...
     public  List<Hospitalization> generateHospitalization() {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            Session serviceSession = provider.getSession();
                serviceSession.beginTransaction();
                NativeQuery serviceQuery = serviceSession.createNativeQuery(Constants.TABLEPERCLASS_APPOINTMENT);
                List<BigInteger>service = serviceQuery.getResultList();
                ...
                NativeQuery hospitalQuery = hospitalSession.createNativeQuery(Constants.TABLEPERCLASS_HOSPITAL);
