...
import ru.sfedu.hospital2.lab3.MappedSuperClass.HibernateDataProvider;
 ...
 * @author Liza
 */
public class MappedGenerator {
    private static final Logger log = LogManager.getLogger(MappedGenerator.class);
    ...
    public  List<Employee> generateEmployee() {
     ...
     public  List<Appointment> generateAppointment() {
        ...
        for (int i = 0; i < 2; i++) {
            Appointment appointment = new Appointment();
                ...
                NativeQuery employeeQuery = employeeSession.createNativeQuery(Constants.MAPPED_EMPLOYEE);
                ...
                NativeQuery patientQuery = patientSession.createNativeQuery(Constants.MAPPED_PATIENT);
     ...
     public  List<Diagnosis> generateDiagnosis() {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            diagnosis.setSignature(false);            
                ...
                NativeQuery serviceQuery = serviceSession.createNativeQuery(Constants.MAPPED_SURVEY);
     ...
     public  List<Hospitalization> generateHospitalization() {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            Session serviceSession = provider.getSession();
                serviceSession.beginTransaction();
                NativeQuery serviceQuery = serviceSession.createNativeQuery(Constants.MAPPED_APPOINTMENT);
                List<BigInteger>service = serviceQuery.getResultList();
                ...
                NativeQuery hospitalQuery = hospitalSession.createNativeQuery(Constants.MAPPED_HOSPITAL);
